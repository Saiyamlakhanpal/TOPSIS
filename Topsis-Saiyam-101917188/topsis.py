...
class topsis:
    r_no = '101917188'
    def __init_(self,input_file,weight_str,impact_str,out_file):
    ...
    def calculate(self):
        ...
        if len(check) != 1:
            print("Number of weights, number of impacts and number of indicators must be same.\n")
            exit()
        ...
        performance_score = np.divide(distances[:,1],np.add(distances[:,0],distances[:,1]))
        ...
        print("Completed succesfully! Check "+ self.out_file+" for the output\n")
